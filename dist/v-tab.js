...
/******/ 	var parentJsonpFunction = window["webpackJsonpVTab"];
/******/ 	window["webpackJsonpVTab"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
/***/ })
	...
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VTab"] = factory();
	else
		root["VTab"] = factory();
})(this, function() {
return webpackJsonpVTab([0],[
/* 0 */,
/* 1 */
...
exports.default = {
  ...
  created: function created() {
    var self = this;
    var tab = { name: this.name, label: this.label, icon: this.icon };
    ...
    this.$parent.$on('activateTab', function (tabName) {
